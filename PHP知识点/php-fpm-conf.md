---
title: php-fpm的常用配置和优化
permalink: php-fpm-conf
date: 2020-01-08 21:12:50
updated: 2020-01-08 21:12:55
tags: 
    - php
categories: php
toc: true
excerpt: 下面列出配置文件php-fpm的各种配置以及一些常见的优化。
---

下面列出配置文件php-fpm的各种配置以及一些常见的优化。
