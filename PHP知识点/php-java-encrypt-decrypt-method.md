---
title: php 与 java对接通用加解密方法
permalink: php-java-encrypt-decrypt-method
date: 2020-01-08 00:23:49
updated: 2020-01-08 21:12:50
tags: 
    - php
    - java
categories: php
toc: true
excerpt: 本文整理了php和java链条过程中，双方通用的加密和解密方法。
---
本文整理了php和java链条过程中，双方通用的加密和解密方法。
